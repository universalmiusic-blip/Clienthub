...
const DB = {
  freelancer: { name: "Carlos Rivera", title: "Diseñador & Desarrollador", avatar: "CR", email: "carlos@clienthub.app", password: "admin", monthlyGoal: 8000 },
  clients: [
  ...
  return (
    <div className="cp-shell">
      <div className="cp-side">
        <div className="side-logo">Client<em style={{color:"#86efac",fontStyle:"normal"}}>Hub</em></div>
...
function Login({ onLogin, lang, setLang }) {
  ...
  const t = TL[lang];
  const demos = [{label:"Freelancer",email:"carlos@clienthub.app",pass:"admin"},{label:"Ana (cliente)",email:"ana@empresa.com",pass:"1234"},{label:"John (cliente)",email:"john@company.com",pass:"5678"},{label:"Lucía (cliente)",email:"lucia@bloom.co",pass:"9999"}];
    ...
    <div className="shell">
      ...
      <div className="main">
        <div className="topbar">
          <div>
            <div className="topbar-title">{titles[view]||"ClientHub"}</div>
